...
var sqlite3InitModule = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    function findWasmBinary() {
      ...
      return new URL("/assets/sqlite3-DBpDb1lf.wasm", import.meta.url).href;
    }
    var wasmBinaryFile;
    ...
    Module.runSQLite3PostLoadInit = function(EmscriptenModule) {
      ...
      globalThis.WhWasmUtilInstaller = function(target) {
        ...
        target.scopedAllocPop = function(state2) {
          ...
          const n = arguments.length ? cache.scopedAlloc.indexOf(state2) : cache.scopedAlloc.length - 1;
          if (n < 0) toss("Invalid state object for scopedAllocPop().");
          if (0 === arguments.length) state2 = cache.scopedAlloc[n];
        ...
        const installOpfsVfs = function callee2(options) {
          ...
          const thePromise = new Promise(function(promiseResolve_, promiseReject_) {
            ...
            const W = new Worker(
              new URL(
                /* @vite-ignore */
                "/assets/sqlite3-opfs-async-proxy-CYRFPDln.js",
                import.meta.url
              )
            );
            setTimeout(() => {
            ...
            state2.verbose = options.verbose;
            state2.littleEndian = (() => {
              const buffer = new ArrayBuffer(2);
              new DataView(buffer).setInt16(0, 256, true);
              return new Int16Array(buffer)[0] === 256;
            ...
            const initS11n = () => {
              ...
              state2.s11n.deserialize = function(clear = false) {
                ...
                if (argc) {
                  ...
                  for (i = 0; i < argc; ++i) {
                    const t2 = typeIds[i];
                    if (t2.getter) {
                      v2 = viewDV[t2.getter](offset, state2.littleEndian);
                      offset += t2.size;
                    } else {
                      n = viewDV.getInt32(offset, state2.littleEndian);
                      offset += 4;
              ...
              state2.s11n.serialize = function(...args) {
                ...
                if (args.length) {
                  ...
                  for (i = 0; i < args.length; ++i) {
                    const t2 = typeIds[i];
                    if (t2.setter) {
                      viewDV[t2.setter](offset, args[i], state2.littleEndian);
                      offset += t2.size;
                    } else {
                      const s = textEncoder.encode(args[i]);
                      viewDV.setInt32(offset, s.byteLength, state2.littleEndian);
                      offset += 4;
                      viewU8.set(s, offset);
                      offset += s.byteLength;
                    }
            ...
            const sanityCheck = function() {
              ...
              try {
                ...
                let rc;
                state2.s11n.serialize("This is ä string.");
                ...
                log("xClose rc =", rc, "sabOPView =", state2.sabOPView);
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
  worker: function() {
    return new Worker(
      new URL(
        /* @vite-ignore */
        "/assets/sqlite3-worker1-bundler-friendly-DF3WqBKq.js",
        import.meta.url
      ),
      {
        type: "module"
...
async function initializeDatabase(config) {
  const promiser = await new Promise((resolve) => {
    const _promiser = sqlite3Worker1Promiser$1({
